...
var ENDSHOW_MESG="放映結束，按一下即可離開。", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=2, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gMainDoc=new Array(new hrefList("slide0001.htm",1,-1,1),new hrefList("slide0002.htm",1,-1,1));
...
var sNext="下一個",sPrev="前一個",sEnd="結束放映",sFont="新細明體",sArrow="箭頭",sFreeform="手繪多邊形",sRect="矩形",sOval="橢圓形"
function ShowMenu()
{
	BuildMenu();
